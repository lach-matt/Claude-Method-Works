...
| Lemma 3, covering the steps is regenerating | PROVED; GUARD | 40 pseudorandom subsets of `Λ₈`, seed 11, plus a one-cell-short control |
...
| **Theorem 7**, the seed | EXHAUSTIVE; MACHINE-CHECKED | branch and bound over 264 / 361 / 385 maximal covering signatures; the solver refuting a cover one cell short over every subset of the same family |
