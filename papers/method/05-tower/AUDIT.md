...
|---|---|---|---|---|
| A-1 | BLOCKING | 3, 13, 23, 336, 342, 346 | Theorem 5(iii) false as written; the thirteenth axis is an envelope (B₁ = least envelope of the doublet, 64.4%), not "carried exactly"; witness inside the tower | |
| A-2 | BLOCKING | 13, 219–230, 282–300, 346 | Theorem 2 stated for one-coordinate F, applied to multi-coordinate fibres; D10's bounds at axes 9 and 12 are not the least envelope (1,638 ≠ 1,654; 60,320 ≠ 70,905); "Table 2 is clause (iv)" false | |
| A-3 | MAJOR | 232 | axis-13 loss misattributed to 2K; it is this axis's parity congruence plus the K = 0 singleton | |
| A-4 | MAJOR | 166–180, 250, 390 | E = 0 provable in two lines from the bound shape; §5 remark attributes the guarantee to treewidth | |
| A-5 | MAJOR | 31 | §0 marks Theorems 2 and 5 MACHINE-CHECKED; the record does not | |
| A-6 | MAJOR | 609; check.py 799–858 | fidelity guard never evaluates a Z3 predicate | |
| A-7 | MAJOR | 48, 552–558, 611; check.py 1104–1122 | seed MACHINE-CHECKED rows lack the two defining guards | |
| A-8 | MAJOR | 131, 176 | φ̂ not monotone by definition; Prop. 2 says it is | |
| A-9 | MAJOR | 13, 346 | abstract vs Corollary 1: how many triangles, "three bounds" then four named | |
| A-10 | MAJOR | 367; figures.py 75 | Figure 2 rims contradict Corollary 1 at 2S′ and 2J | |
| A-11 | MAJOR | 452–460, 86 | §6.2: eight undefined quantities, trivial proposition, Harary uncited, r reused | |
| A-12 | MINOR | 276, 578; check.py 732 | Theorem 1's Z3 form is j = j′; reduction unstated | |
| A-13 | MINOR | check.py 908–913 | obligations for Theorem 3 labelled "Theorem 5(i)/(ii)" | |
| A-14 | MINOR | 384 | "twelve" within-block bounds; eleven | |
| A-15 | MINOR | 504 | "20!" should be "17!" | |
| A-16 | MINOR | 205, 428, 444; check.py 320, 362 | ⟨q⟩ middle four, Prop. 13's two failure counts, μ(0,·) not asserted | |
| A-17 | MINOR | 45–53, 572–604 | SAMPLED unused; GUARD used and unlisted | |
| A-18 | MINOR | 592; SOURCES.md | "independent derivation" is a hand-typed edge list | |
| A-19 | MINOR | 444 | "larger than the set is short" unparseable | |
| A-20 | MINOR | 400 | Prop. 10 proof: q ≤ k also names q | |
| A-21 | MINOR | SOURCES.md | departure from the source's exact/envelope grading of Λ₉, Λ₁₀, Λ₁₃ unrecorded | |
| A-22 | MINOR | check.py 632–639 | axis-10 exact fibre omits the conjugate ceiling; harmless at D11 | |
| A-23 | MINOR | 5 | date 21 September; finished 24 September | |
| A-24 | MINOR | pp. 7, 14, 16, 16, 19 | stray "Figure n" alt-text label above each caption | |
| A-25 | MINOR | pp. 11–13 | Theorem 2/4/5 clauses render as "1., 2., 1., 2." against (i)–(iv) in the proofs | |
| A-26 | MINOR | p. 13 | §5 edge list collapses to one run-on line | |
| A-27 | MINOR | p. 22 | "Table 5." caption orphaned at a page foot, table on p. 23 | |
| A-28 | MINOR | pp. 16, 19 | Figure 4 labels on markers; Figure 5 legend on the band | |
| A-29 | MINOR | pp. 5, 8 | one-character columns a third of the width | |
| R-1 | BLOCKING | 342 | (mathematician) Theorem 5(iii)'s identity is false — same repair as A-1 | |
| R-2 | BLOCKING | 282–300 | (mathematician) Theorem 2's scope and "least" — same repair as A-2 | |
| R-3 | MAJOR | 166–180, 390 | (mathematician) E = 0 unproved though provable — same repair as A-4 | |
| R-4 | MAJOR | 452–460 | (mathematician) Prop. 14's undefined objects — same repair as A-11 | |
| R-5 | MINOR | 478–492 | (mathematician) Prop. 16's argument stated in the wrong order | |
| R-6 | MINOR | 556 | (mathematician) state the branch-and-bound's bound | |
| R-7 | MAJOR | 131, 176 | (mathematician) φ̂'s definition — same repair as A-8 | |
| R-8 | MAJOR | 3, 13, 23, 25, 122, 228, 336 | (physicist) spin-½ constant contradicts 2S′ ≤ 3, g ≤ 3; jK is a one-electron scheme; state the scope | |
| R-9 | MAJOR | 107–109, 114–118 | (physicist) which state 2Jₚ labels (ℓᵏ before the transfer vs the residual core ℓ^{k−q}) | |
| R-10 | MINOR | 192; References | (physicist) triangle rule is not Racah's; cite Racah 1942, Phys. Rev. 61, 537 for jK | |
| R-11 | MINOR | 109 | (physicist) "target's orbital momentum" is the outer electron's l only at g = 1 | |
| R-12 | MINOR | 232 | (physicist) the ⅔ is parity — same repair as A-3 | |
| R-13 | MINOR | 225–230 | (physicist) row "11 (wider)" is an interval bound, not an exact fibre | |
| R-14 | MINOR | 200 | (physicist) particle–hole equivalence is Condon and Shortley ch. VII first | |
| R-15 | MAJOR | 252–276, 324–336; References | (referee) Theorems 1, 4(i) are Topkis 1978/1998 (Milgrom–Shannon 1994); Theorems 3–4 are max-closed constraints, Jeavons–Cooper 1995, Jeavons–Cohen–Gyssens 1997 | |
| R-16 | MAJOR | 13, 31 | (referee) abstract/§0 promise vs delivery — same repairs as A-1, A-5, A-9 | |
| R-17 | MAJOR | 605–613; check.py | (referee) the guards the record claims are not the guards run — same repairs as A-6, A-7 | |
| R-18 | MINOR | References; 454, 560 | (referee) missing: Harary 1953; Johnson 1974, Lovász 1975, Chvátal 1979; Dilworth 1950; Racah 1942 (Phys. Rev. 61, 537) | |
| R-19 | MINOR | 367 | (referee) figure contradicts text — same repair as A-10 | |
| R-20 | MINOR | 45–53 | (referee) status table — same repair as A-17 | |
