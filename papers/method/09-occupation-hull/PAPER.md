...
(a) A frame F(N, Λ) ⊇ F(15, 4) is the union of its subshells with n ≥ 38 (resp. 56), which change nothing, and a set between F(15, 4) and F(37, 36) (resp. F(55, 54)), which by monotonicity gives the F(15, 4) corridor. (b) A finite set S ⊇ F(12, 4) lies inside some F(N, N − 1) with N ≥ 15; F(12, 4) gives the F(15, 4) corridors at every step in both forms (EXHAUSTIVE), F(N, N − 1) does by (a), and S lies between them. (c) The set in question is the intersection of the open half-lines of Lemma 1 over all admissible subshells; each half-line from a subshell with n ≥ 38 (resp. 56) contains the F(15, 4) corridor, and the remaining half-lines are those of F(37, 36) (resp. F(55, 54)), whose intersection is that corridor. ∎ **PROVED**, with its extremes and its three closed frames **EXHAUSTIVE**.
