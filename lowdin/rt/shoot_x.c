...
void shoot_x(int n, double h, const double *f, const double *s, int m, int ie, double y0, double y1, double p0, double p1,
             double *yoh, double *yop, double *yih, double *yip)
{
    ...
    yip[ie] = p0; yip[ie-1] = p1;                  /* start from the OLD orbital (Fischer): admixture = change only */
    for (i = ie-1; i > m; i--) {
