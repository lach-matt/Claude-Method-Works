...
FINDINGS = [
 ...
 ("LEDGER",          0, -1,  0, "obstruct.py",
  "of thirty-five obstructions six dissolved, three relocated, seventeen closed negative, seven conditional, two open and none untested"),
]
...
def selftest():
    ...
    chk("number of findings indexed", len(FINDINGS), 304)
