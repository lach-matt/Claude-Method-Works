...
FINDINGS = [
 ...
 ("LEDGER",          0, -1,  0, "obstruct.py",
  "of thirty-four obstructions six dissolved, three relocated, sixteen closed negative, seven conditional, two open and none untested"),
]
...
def selftest():
    ...
    chk("number of findings indexed", len(FINDINGS), 297)
