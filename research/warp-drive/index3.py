...
def selftest():
    ...
    chk("number of findings indexed", len(FINDINGS), 316)
    ...
    chk("cells sitting on all three axes", sorted(triple), sorted([
                "ACHRONAL","ANEC-CROSS-CHECKED","ANEC-RELOCATES","ANEC-VIOLATED","AREA-OVER-THICK","BANK-LOAN-THEOREM","BH-IS-WRONG-SIGN","BUILT-SOURCE","CASIMIR-ROUTE","CATALOGUE","CHANGE-OF-KIND","CHARGE-NO-LEAD","CLASSICAL-WINS","COLLAPSE-BINDS-RICCI","CONTRACTION-LAW","CONVERSION-IS-DONE","CORE-IS-TYPE-I","CORRIDOR-NOT-A-BH","COST-DOES-NOT-CLOSE-IT","COST-IS-ONE-NUMBER","COUNTING-CLOSES-IT","D-CANCELS","DESIGN-EQUATION","DEVICE-IS-CLASSICAL","DEVICE-NOT-RETRACTED","DEVICE-SEATS-LEADS","DISSENT-IS-VALUE","EC-TAKEN","EFFICIENCY-CANNOT","EM-GAP","EM-IS-ORDINARY","ENTANGLEMENT-IS-IT","ENTROPY-IS-PLANCK-DENOMINATED","ESCAPES-TYPE-I","EXCHANGE-RATE","EXTERNAL-PATH-ESCAPE","FLYBY","FORD-ROMAN-DERIVED","GAIN-SATURATES","GAP-IS-THE-LEVER","GAP-WIDENS","GJW-IS-EXISTENCE-PROOF","KAPPA-IS-THE-ONLY-LEVER","KERR-FLYBY","LAUNCHER","LEAD-IS-INTERIOR","LENSING-IS-THE-SEAT","LIMIT-DISSOLVES","LOG-AGAINST-LINEAR","LOG-COORDINATE","LONG-AND-WEAK","LOOP-OBSERVABLE","MAGNITUDE-REACHED","NARROWER-CLOSING","NO-ACHIEVABLE-CORE","NO-ACHRONAL-VIOLATOR","NO-BUCHDAHL","NO-EXOTIC","NO-GEOMETRY-LEFT","NO-HORIZON","NO-MOMENTUM-FLUX","NO-NULL-QI","NO-THROAT","NOT-POWERED","NOTHING-STRUCTURAL","OBJ-CEILING","OBSERVED-ENGINE","ONE-AXIS-FLAT","ONE-NAME-AGAIN","ONE-OBSTACLE","ONE-SIGN-EXOTIC","OPEN-GATE","ORDER-MOVED","ORDINARY-MATTER","PERMISSION-NOT-DISCOUNT","PHASE-1-CLOSES","PLANCK-FACTOR-CANCELS","PLANCK-FOURTH-TIME","PLANCK-THIRD-TIME","POWER-MAKES-IT-WORSE","PRESSURE-CAPPED","PRINCIPLED-VS-BUILDABLE","PROPER-IS-THE-ACT","PROPER-IS-THE-QUANTITY","SAVING-DOESNT-SCALE","SCALE-THEOREM","SCOPE-DROPS-LEAD","SEAT-IS-THE-ESCAPE","SEAT-VS-CONTRACTION","SEATS-AND-EARLY","SECOND-COSTS-1E4-SUNS","SHEAR-CLAIM-INVERTED","SHELL-IS-ORDINARY","SHELL-THEOREM-SPLIT","SIGN-IS-THE-ONLY-QUESTION","SIGN-NOT-POWER","SIGN-STRUCTURE-3","SLINGSHOT","SNEC-INHERITS-ANEC","SPACE-TIME-ONE","STABLE-FOR-FREE","STANDING-COUPLING","STATE-NOT-ELEMENT","STATIC-IS-THE-SPLIT","STIFF-WALL","STIFFNESS-IS-THE-COST","STURM-IMPLIES-COLLAPSE","THE-DICHOTOMY","THE-DOOR","THE-SPLIT","THE-TRADE","THE-WINDOW","THEOREM-IS-FREE","THEOREM-REPRODUCES","THREE-ARE-ONE","THREE-CROSSINGS-AGREE","THREE-ROWS-ADMIT","TIME-CHEAPER-METRIC","TRANSITION-DEFINED","TRANSITION-EQUATION","TWENTY-NOT-65-ORDERS","TWO-CONSTANTS-AGREE","TWO-ROUTES-AGREE","TYPE-IV","UNIVERSAL-SEAT","VACUUM-DEMONSTRATION","VACUUM-FORCES-WEYL","VACUUM-NOT-MATERIAL","VACUUM-PATH","VACUUM-SATURATES-QNEC","VALUE-IS-AMORTISED","WEYL-IS-SIGNBLIND","ZERO-ADM-DEVICE","ZERO-POINT-IS-THE-FLOOR"]))
    aff = [f[0] for f in FINDINGS if coords(f) == (1,1,1)]
    chk("cells affirmative on all three", sorted(aff), sorted([
                "ANEC-CROSS-CHECKED","BH-IS-WRONG-SIGN","BUILT-SOURCE","CASIMIR-ROUTE","CATALOGUE","CHANGE-OF-KIND","CLASSICAL-WINS","COLLAPSE-BINDS-RICCI","CONTRACTION-LAW","CORE-IS-TYPE-I","CORRIDOR-NOT-A-BH","COST-DOES-NOT-CLOSE-IT","COST-IS-ONE-NUMBER","D-CANCELS","DESIGN-EQUATION","DEVICE-IS-CLASSICAL","DEVICE-NOT-RETRACTED","DISSENT-IS-VALUE","EC-TAKEN","EM-IS-ORDINARY","ENTANGLEMENT-IS-IT","ENTROPY-IS-PLANCK-DENOMINATED","ESCAPES-TYPE-I","EXTERNAL-PATH-ESCAPE","FLYBY","FORD-ROMAN-DERIVED","GJW-IS-EXISTENCE-PROOF","KERR-FLYBY","LENSING-IS-THE-SEAT","LIMIT-DISSOLVES","LOG-COORDINATE","LONG-AND-WEAK","LOOP-OBSERVABLE","MAGNITUDE-REACHED","NO-ACHRONAL-VIOLATOR","NO-BUCHDAHL","NO-EXOTIC","NO-HORIZON","NO-MOMENTUM-FLUX","NO-NULL-QI","NO-THROAT","NOT-POWERED","NOTHING-STRUCTURAL","OBSERVED-ENGINE","ONE-SIGN-EXOTIC","ORDER-MOVED","ORDINARY-MATTER","PLANCK-FACTOR-CANCELS","PLANCK-FOURTH-TIME","PLANCK-THIRD-TIME","PRESSURE-CAPPED","PRINCIPLED-VS-BUILDABLE","PROPER-IS-THE-ACT","PROPER-IS-THE-QUANTITY","SCALE-THEOREM","SCOPE-DROPS-LEAD","SEAT-IS-THE-ESCAPE","SEAT-VS-CONTRACTION","SEATS-AND-EARLY","SHEAR-CLAIM-INVERTED","SHELL-IS-ORDINARY","SHELL-THEOREM-SPLIT","SIGN-IS-THE-ONLY-QUESTION","SIGN-STRUCTURE-3","SLINGSHOT","SPACE-TIME-ONE","STABLE-FOR-FREE","STANDING-COUPLING","STATE-NOT-ELEMENT","STATIC-IS-THE-SPLIT","STIFF-WALL","THE-DOOR","THE-SPLIT","THE-WINDOW","THEOREM-IS-FREE","THEOREM-REPRODUCES","THREE-CROSSINGS-AGREE","THREE-ROWS-ADMIT","TIME-CHEAPER-METRIC","TRANSITION-DEFINED","TRANSITION-EQUATION","TWENTY-NOT-65-ORDERS","TWO-CONSTANTS-AGREE","TWO-ROUTES-AGREE","UNIVERSAL-SEAT","VACUUM-DEMONSTRATION","VACUUM-FORCES-WEYL","VACUUM-NOT-MATERIAL","VACUUM-PATH","VACUUM-SATURATES-QNEC","VALUE-IS-AMORTISED","WEYL-IS-SIGNBLIND","ZERO-ADM-DEVICE"]))
