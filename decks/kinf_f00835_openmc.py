"""k_inf of the design fuel salt at a stated fissile fraction.
    ...
    fissile fraction of heavy metal   0.08346
...
that are not the question.
    ...
    one-group prediction, registered in advance: k_inf = 1.0000
"""
import openmc

salt = openmc.Material(name='NaCl-UCl3 fuel salt')
salt.add_nuclide('Cl35', 2.39013334e-04, 'ao')
salt.add_nuclide('Cl37', 2.36623200e-02, 'ao')
salt.add_nuclide('Na23', 1.40630733e-02, 'ao')
salt.add_nuclide('Pu239', 2.73700396e-04, 'ao')
salt.add_nuclide('U238', 3.00571964e-03, 'ao')
