"""k_inf of the design fuel salt at a stated fissile fraction.
    ...
    fissile fraction of heavy metal   0.07000
...
that are not the question.
    ...
    one-group prediction, registered in advance: k_inf = 0.9187
"""
import openmc

salt = openmc.Material(name='NaCl-UCl3 fuel salt')
salt.add_nuclide('Cl35', 2.39018650e-04, 'ao')
salt.add_nuclide('Cl37', 2.36628464e-02, 'ao')
salt.add_nuclide('Na23', 1.40633861e-02, 'ao')
salt.add_nuclide('Pu239', 2.29564509e-04, 'ao')
salt.add_nuclide('U238', 3.04992847e-03, 'ao')
