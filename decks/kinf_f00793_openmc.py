"""k_inf of the design fuel salt at a stated fissile fraction.
    ...
    fissile fraction of heavy metal   0.07930
...
that are not the question.
    ...
    one-group prediction, registered in advance: k_inf = 0.9758
"""
import openmc

salt = openmc.Material(name='NaCl-UCl3 fuel salt')
salt.add_nuclide('Cl35', 2.39014977e-04, 'ao')
salt.add_nuclide('Cl37', 2.36624827e-02, 'ao')
salt.add_nuclide('Na23', 1.40631699e-02, 'ao')
salt.add_nuclide('Pu239', 2.60059797e-04, 'ao')
salt.add_nuclide('U238', 3.01938278e-03, 'ao')
