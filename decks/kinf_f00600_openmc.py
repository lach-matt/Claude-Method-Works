"""k_inf of the design fuel salt at a stated fissile fraction.
    ...
    fissile fraction of heavy metal   0.06000
...
that are not the question.
    ...
    one-group prediction, registered in advance: k_inf = 0.8524
"""
import openmc

salt = openmc.Material(name='NaCl-UCl3 fuel salt')
salt.add_nuclide('Cl35', 2.39022600e-04, 'ao')
salt.add_nuclide('Cl37', 2.36632374e-02, 'ao')
salt.add_nuclide('Na23', 1.40636185e-02, 'ao')
salt.add_nuclide('Pu239', 1.96772830e-04, 'ao')
salt.add_nuclide('U238', 3.08277434e-03, 'ao')
