"""k_inf of the design fuel salt at a stated fissile fraction.
    ...
    fissile fraction of heavy metal   0.09000
...
that are not the question.
    ...
    one-group prediction, registered in advance: k_inf = 1.0367
"""
import openmc

salt = openmc.Material(name='NaCl-UCl3 fuel salt')
salt.add_nuclide('Cl35', 2.39010751e-04, 'ao')
salt.add_nuclide('Cl37', 2.36620643e-02, 'ao')
salt.add_nuclide('Na23', 1.40629213e-02, 'ao')
salt.add_nuclide('Pu239', 2.95144614e-04, 'ao')
salt.add_nuclide('U238', 2.98423998e-03, 'ao')
