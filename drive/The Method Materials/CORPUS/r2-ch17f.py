...
print('  IoI sites of "from the subject or from nowhere":', ioi_hits, '; the phrase at L9926 is not a quotation (no quotation marks):', '"coordinates come' not in M[9925])
print('  "envelope precision only" (L9898) vs §18.4.1 L5154–L5155 "the book\'s prediction is envelope precision only" — read on the join:', 'envelope precision only' in norm(M[5153] + ' ' + M[5154]), '; L9898 attributes it to §12.11.2; §12.11.2 span carries "envelope":', has_token('\n'.join(M[3362:3393]), 'envelope'))
print('  L9898 "nothing here touches Poincaré" is quoted; §31.1.1 carries it verbatim:', sum('nothing here touches Poincaré' in l for l in M[8617:8650]))
