...
print('  row 4.1 "1,169 of 1,654 cells": Λ₉ = %d == 1,654: %s (composable 1,169: located at source in §3; the composability relation is Chapter 19\'s — INFERRED, not rebuilt here)' % (n9, n9 == 1654))
