...
check('entries (heading lines)', len(heads), 1635)
check('bare / grouped', (len(bare), len(grouped)), (1628, 7))
check('distinct numbers', len(allnums), 1660)
...
check('numbers absent in 1..1792', len(absent), 132)
