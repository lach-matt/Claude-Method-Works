...
print('   ', MAIN[9157].strip())
sub32 = [MAIN[i].strip() for i in range(8789, 9393) if re.match(r'^#{3,4} 32', MAIN[i].strip())]
...
WIT = [9157, 9165, 9181, 9188, 9199, 9207, 9222, 9239, 9246, 9255, 9268, 9270, 9281, 9294, 9298, 9302]
...
for rid, l, tok in ((713, 9168, '32.5'), (1191, 9158, 'never'), (1192, 9273, 'never'), (1193, 9304, 'never')):
