...
print('  MC L1254 cites "the admissibility condition (§14.4)":', 'admissibility condition (§14.4)' in VOL['mc'][_L('    Both are the same error as the audits they were written to replace: a check looking at the')], '— the same pointer in the Mathematical Compendium')
