...
# r2-ch25a2.py — R3 (chat 153-R) — SUCCESSOR to r2-ch25a.py, re-anchored by tools/reanchor.py: every main-volume line the
# predecessor pinned as a literal is resolved by the text of the line it pointed at in the bundle its golden was
# banked against (2 anchors); nothing else changes. r2-ch25a.py is seated and never edited in place (chat 68).
# PROVED by tools/proveanchor.py when the line below says so; until then this file is a draft.
# PROVEANCHOR: 90+184 — reproduces r2-ch25a.out byte-exact on those bundles (G0c)
...
print('   broken fraction L11165–L11168 (docket 28 site):'); [print('   L%d %r' % (i, M[i - 1].rstrip())) for i in range(_L('  the step law, 3·2^(d−2)    Rival 1973 — \\                                                                     K ≤    L for a'), _L('                                                                                                                  )\\', 1))]
