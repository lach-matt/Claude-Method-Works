...
# PROVEANCHOR: NOT PROVED on 90+184, 92+188 or 98+202 — reproduces r2-ch16v2.out byte-exact on those bundles (G0c)
...
print('    ' + norm(REG[_L('  φ(a) = 4 − a, single, decreasing      875               0        no              no')])[:260])
...
print('    reg L5017 tail: ' + norm(REG[_L(" coordinate — and register 275's two levers say both directions must be searched, since E falls as a")])[-60:])
