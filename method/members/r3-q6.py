#!/usr/bin/env python3
"""r3-q6.py — R3: Q5 pass 6. Registers 603, 604 and 605 corrected from the seed-cap return (SEED-CAP-FINDING.md,
EXPANSION-MC54.md in the mirror) as registers 1833, 1834 and 1835, every figure re-derived first by r3-q6-measure.py — a
...
# Register 1820 is cited by all three entries and reaches eight citations: its row is hand-written here (a new row is a hand act) and its headline asserted.
NEW_ROWS = {1820: "REGISTER 602'S 219 MINIMUM COVERS ARE A SAMPLE OF THE 24,585 ENUMERATED EXACTLY, AND THE ENTRY AND §14.5.12 NOW POINT AT THE EXACT COUNT."}
