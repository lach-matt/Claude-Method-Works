# r2-ch20a3.py — successor of r2-ch20a2.py (md5 78c9be416a73aa52e125085d0fc48ab1), W-235 / DEF-153N: the predecessor's tuple of REGISTER NUMBERS
# (1578, 1699, 1700, 1763, 1768) — the entries the unit cites — had its numbers turned into _L(<main-volume text at that
# line>) by tools/reanchor.py (its documented blind spot: a number in the line range that is not a line), so when main moved
# +5 above L1452 the loop printed registers 1583, 1704, 1705, 1768 and 1773 for the five, and the banked golden names the
# wrong entries. One replacement: the five numbers are numbers again. Nothing else changes.
