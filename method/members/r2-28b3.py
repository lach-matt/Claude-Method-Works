#!/usr/bin/env python3
# r2-28b3.py — chat 153 — SUCCESSOR to r2-28b2.py, re-anchored. Identical measurements; one pin moves.
# r2-28b2 pinned the `### R.7` heading to the literal [11806], which the +8 shift moved to 11814.
...
# r2-28b2 is seated and is never edited in place (chat 68).
# PROVED by tools/proveanchor.py: reproduces r2-28b2.out byte-exact on the pre-shift bundles (G0c).
...
_s35_alt = [i for i, l in enumerate(M, 1) if 'works Chapter 35 rests on' in l]
check('sentence A "these are the works Chapter 35 rests on" sits at', S35, _s35_alt)
