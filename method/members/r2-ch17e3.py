...
print('  "344 cells, 0 join failures, 8,385 meet failures" vs r2-tb1 own cap 8:', T.own[T.caps.index(8)][:3] == (344, _L('  distinct rows                        mean steps                 max         max / d²'), 0))
...
print('  §25.6 "E(Λ) = 0" / "proposes none" / "complete index" (the unit\'s "E = 0 and makes no predictions"):', 'E(Λ) = 0' in t, 'proposes none' in t, has_token(t, 'complete index'), '; L7000 is a post-PP forward pointer to Chapter 36 itself (E(Λ₃) = 0):', 'E(Λ₃) = 0' in M[_L(' information. That is stated here so a referee does not have to ask.')])
