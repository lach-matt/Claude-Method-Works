...
- Live files, both in `method/` and asserted by `method/verify.py`: **BUILD90 main** (1,983,081 B · 49065309b0c4fe8e055f693aed295cca · 18,470 lines · 2 members, unchanged since chat 62) and **BUILD182 compendia** (5,864,276 B · 27e66a61061cec78283c4a88d53ba964 · 66,440 lines · 349 members). 351 members in all. Register 1 to 1792. **W-191 seated.**
- BUILD181 and BUILD182 were rebuilt here from BUILD180 plus the chat-151-B parts fetched from Drive, and every assertion in `REBUILD-BUILD181.md` and `REBUILD-BUILD182.md` held: 15 of 15 parts byte-exact against their published md5s, both goldens regenerated byte-exact (`r2-26c.out` 13,613 B · c1e19648b3d258166e9d6d977baee88f · 156 lines; `r2-27a.out` 10,142 B · 38e112883a8ce6b581e471b3f866f2c1 · 125 lines), and each reverse guard recovering its predecessor. Derivations, not transcriptions.
- **The chain is ahead of this tree.** Chat 151-B has closed **BUILD183** in Drive (`W-192`, 28a-06 — the author-and-year match measured at **52 of 162** against the printed *Fifty-nine*). `BUILD183-PARTS` was still being uploaded when this was written; rebuild it here the same way once complete.
- Next work: DEF-143 item 11's order is nearly done — **28b-06's reading of Register 1721 is the last family**. Then M's compendia-scope ruling, staged at `method/RUL-151B-PENDING.md` and not yet seated: the Register read in full in source order, the other four compendia by class sweep.
