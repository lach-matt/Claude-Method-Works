...
- Live files, both in `method/bundles/` and asserted by `method/verify.py`: **BUILD91 main** (1,987,447 B · 7ff88249adc3b00f95a30b97e879e500 · 18,485 lines · 2 members) and **BUILD180 compendia** (5,757,241 B · ea5becc40e13debe4faaf6c7e0cde960 · 65,420 lines · 341 members). 343 members in all. Register 1 to 1796. **W-189 seated; W-190 drafted and NOT seated.**
...
- **KNOWN STALE, not repaired:** the compendia bundle's `MANIFEST.tsv` member still records the main bundle's Register at 1,203,491 B · 79aaf239a42c1649e914b7cba9d5ce2a. The next `close.py` run regenerates those rows; pass `--main` the BUILD91 path.
