...
- Live files, both in `method/` and asserted by `method/verify.py`: **BUILD91 main** (1,985,872 B · 7d056e31a931a3c6802eea739af91e0f · 18,478 lines · 2 members — the first main-volume change since chat 62: R3 class CINF, 2026-09-24, entry 1793 and §35's three sites, `docs/R3-CLASS-CINF.md`) and **BUILD181 compendia** (5,760,530 B · 78120e152d359972a214adbee7669e66 · 65,429 lines · 341 members — the same class's paper and compendia sites, W-190). 343 members in all. Register 1 to 1793. **W-190 seated.** BUILD90 (49065309…) and BUILD180 (ea5becc4…) stay beside them until retired; `gate.py`'s MAIN default is still the BUILD90 path (use `--main`), and `census.py` still hard-codes `n>1792` (W-168).
...
- The review plan: R1 instrumented census → **R2 full read in source order (the main volume CLOSED in full at chat 141, W-181; in progress: RUL-128 item 3 (ii), the Register and Mathematical Compendium re-derivations — DEF-143 item 11's order, 26b-02 and 26b-03 next)** → R3 corrections by class → R4 cross-volume audit. Then the compendium task line: renumber → bibliography → Register expansions → main-volume prose.
