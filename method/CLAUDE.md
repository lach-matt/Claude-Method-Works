...
- **Drive stands at BUILD184; this tree at BUILD194 / BUILD94. THE RECONCILIATION IS NOW OVERDUE.** Chat 151-R set the bound at two builds on either surface; this session advanced main by two (92 → 94) and compendia by three (191 → 194). Under M's **hybrid** ruling — Drive is the store for Cowork chats, the repository for Claude Code sessions, one session that reaches both reconciles — a session that can reach both owes the reconciliation before R3 continues.
