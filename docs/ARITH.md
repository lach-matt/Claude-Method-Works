...
precedents, and it is most of the work: of 282 claims in the reader-facing members, **212 are
...
Over `--roster reader-facing` (the six volumes and the two papers), 282 claims:

```
AGREE 66   WITHIN-INPUT-PRECISION 2   DISAGREE 2   NOT-BOUND 212
```
