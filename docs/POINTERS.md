...
Over `--roster with-companion`, 2,094 pointer tokens:

```
RESOLVED-HERE 438  RESOLVED 1547  AMBIGUOUS 65  PARTIAL 19
...
The Register's extent is stated as 1 to 1853; 1,720 of those numbers carry a `###` entry and 133 do
