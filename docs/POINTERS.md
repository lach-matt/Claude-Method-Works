...
Over `--roster with-companion`, 2,142 pointer tokens:

```
RESOLVED-HERE 438  RESOLVED 1595  AMBIGUOUS 65  PARTIAL 19
...
The Register's extent is stated as 1 to 1885; 1,752 of those numbers carry a `###` entry and 133 do
