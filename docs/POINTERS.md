...
Over `--roster with-companion`, 2,110 pointer tokens:

```
RESOLVED-HERE 438  RESOLVED 1563  AMBIGUOUS 65  PARTIAL 19
...
The Register's extent is stated as 1 to 1864; 1,731 of those numbers carry a `###` entry and 133 do
