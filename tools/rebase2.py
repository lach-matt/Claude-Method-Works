...
def render(g):
    ...
    a("")
    a("## 5. The joinder: the water route")
    a("")
    a("Title I's summer surplus lifts this water to an elevated reservoir and its October-to-April")
    ...
    a("")
    a("On the power side the water route and the mirrors are at parity; what the water route adds is a")
    ...
    a("- The takers: a million acre-feet a year of winter delivery needs contracted recharge districts.")
