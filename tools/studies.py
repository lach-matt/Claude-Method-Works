...
STUDIES = [
    ...
    ("field", "Crescent Dunes (SolarReserve to 2020; ACS/Cobra from 2020; sold in Chapter 11, 2026), Nevada", "110 MWe, 10 h salt, 1.2 M m2", 2015, "OPERATED",
     "US utility-scale salt tower; four hot-salt tank leaks (October 2016, March 2019, February 2022, February 2023); after a 2023 root-cause analysis the hot tank runs at 455-480 C (850-900 F) instead of ~565 C and output is constrained to ~55 MW, half of design; 196 GWh in 2018, its best full year, 0.39 of the 500 GWh design; NV Energy's 25-year PPA at ~$135/MWh terminated October 2019; short-term and month-to-month offtake since late 2020; a second Chapter 11 filed January 2026 and the plant sold for $7 M in March 2026",
     "In re Tonopah Solar Energy, LLC, No. 26-10060 (Bankr. D. Del., filed 2026-01-21), first-day declaration and sale order; EIA Form 923, plant 57275; DOE Loan Programs Office; SolarPACES 'What happened with Crescent Dunes'"),
