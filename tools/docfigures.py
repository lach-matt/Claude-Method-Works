...
def checks():
    ...
    return [
        ...
        ("docs/REGISTER-GAPS.md", "The Register entries", 1719, len(R)),
...
def _instrument_rows():
    ...
    return [
        ("docs/POINTERS.md", "pointer tokens, --roster with-companion", 2092, len(sites)),
        ("docs/POINTERS.md", "findings", 44, sum(1 for s in sites if _is_finding(s))),
        ("docs/POINTERS.md", "RESOLVED", 1545, pv("RESOLVED")),
