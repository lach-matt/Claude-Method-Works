...
def checks():
    ...
    return [
        ...
        ("docs/WEB-INDEX.md", "site papers: released papers held", 3,
        ...
        ("docs/WEB-INDEX.md", "site nuclear band index: 2,152 members, 121 cells, K2, refusals 27 + 93 + 6",
         {"members": 2152, "cells": 121, "channel": 2, "refusals": [27, 93, 6], "census_exact": True, "deformed": "234 of 234 entries, total, not seated"},
        ...
        ("docs/WEB-INDEX.md", "site predictions: 3,206 demanded over 22 indexes, 16 predicting, 593 / 36 / 2,479 / 98",
         {"total_E": 3206, "predicting": 16, "complete": 6, "totals": {"E": 3206, "forbidden": 593, "unplaced": 36, "open": 2479, "undecided": 98}},
