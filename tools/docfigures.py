...
def checks():
    ...
    return [
        ...
        ("docs/WEB-INDEX.md", "site sub-population sweep: 143 closed sets, 2 hits, exhaustive chains 5, 7, 6, 14, 3 lattices",
         {"closed_sets": 143, "hits": 2, "exhaustive_chains": [5, 7, 6, 14], "lattices": 3},
         {k: v for k, v in (((_site_index()["particle_index"] or {}).get("subpop") or {}).items()) if k != "tested"}),
