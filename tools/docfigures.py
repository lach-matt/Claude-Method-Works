...
def checks():
    ...
    return [
        ("CLAUDE.md", "members extracted from the bundles", 759,
        ...
        ("docs/REGISTER-GAPS.md", "The Register entries", 1757, len(R)),
...
def _instrument_rows():
    ...
    return [
        ("docs/POINTERS.md", "pointer tokens, --roster with-companion", 2148, len(sites)),
        ("docs/POINTERS.md", "findings", 44, sum(1 for s in sites if _is_finding(s))),
        ("docs/POINTERS.md", "RESOLVED", 1601, pv("RESOLVED")),
