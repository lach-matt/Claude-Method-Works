...
def checks():
    ...
    return [
        ...
        ("docs/WEB-INDEX.md", "site sub-population sweep: 2 hits, exhaustive chains 5, 7, 6, 14, 3 lattices",
         {"hits": 2, "exhaustive_chains": [5, 7, 6, 14], "lattices": 3},
        ...
        ("docs/WEB-INDEX.md", "site register: 26 seated indexes on all eight channels", {"count": 26, "occupied": [0, 1, 2, 3, 4, 5, 6, 7], "all_occupied": True},
        ...
        ("docs/WEB-INDEX.md", "site predictions: 4,759 demanded over 24 indexes, 18 predicting, 1,974 / 36 / 2,651 / 98",
         {"total_E": 4759, "predicting": 18, "complete": 6, "totals": {"E": 4759, "forbidden": 1974, "unplaced": 36, "open": 2651, "undecided": 98}},
