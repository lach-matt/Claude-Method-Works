...
def checks():
    ...
    return [
        ...
        ("docs/REGISTER-GAPS.md", "The Register entries", 1720, len(R)),
...
def _instrument_rows():
    ...
    return [
        ("docs/POINTERS.md", "pointer tokens, --roster with-companion", 2094, len(sites)),
        ("docs/POINTERS.md", "findings", 44, sum(1 for s in sites if _is_finding(s))),
        ("docs/POINTERS.md", "RESOLVED", 1547, pv("RESOLVED")),
        ...
        ("docs/ARITH.md", "claims checked, --roster reader-facing", 273, len(claims)),
        ...
        ("docs/ARITH.md", "NOT-BOUND", 206, av("NOT-BOUND")),
    ]
