#!/bin/sh
# The Method 1.9 — the prose-pass print. SIX volumes, figures placed from
...
# The Three-Body paper is NOT one of the volumes — it is contributing information
# (M, 2026-09-11). build.py's SUBS is keyed by these six and no more, which is the
# store saying so; its lack of an entry was never a gap.
set -e
