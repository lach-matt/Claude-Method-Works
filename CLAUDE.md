...
lists what each paper leaves to M, and records what M has since settled: on 2026-09-24 the working titles, the lawrencium configuration behind the piercing theorem, the polarisation prefactor and the sources of the forty-two chemical properties, and, later the same day, every remaining open point the tree or the literature could settle, each with its disposition. **The papers claim less than
...
of the method equation, per register 1206), `tools/slopeaxis.py` (Chapter 34's occupation law as
...
hand-edited), `tools/orderideal.py` (register 66's downward-closure
...
`docs/SLOPE-AXIS.md`, `docs/COVERAGE.md`, `docs/ORDER-IDEAL.md` and `docs/DOCFIGURES.md`.
