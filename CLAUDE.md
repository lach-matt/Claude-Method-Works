...
**`tools/lowdin_walk.py`** (the Löwdin solution's entrant walk, reconstructed in a local-exchange
field at c = 137.035999 and c → ∞ and written to `LOWDIN-WALK.tsv`; its selftest is exact
...
**Run it after any pass that changes a count** — 74 pinned figures, ~4 s, exits 1 on drift. The
