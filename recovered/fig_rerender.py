...
def f241():
    ...
    def get(sp):
        ...
        return out
    species=['Al I','Al II','Ar II','Be I','Be II','Bi I','C II','Ca II','Cd II','Ga I','He I','Hg II','K I','K II','Li I','Li II','Mg II','N II','Na I','Na II','Ne I','Si I','Si II','Zn II']
    ...
    ax.plot([0,6],[7.6e-5,1.6e-6],'--',color='#1f6f8b',lw=1.2,label='He II (§24.4 endpoints)'); ax.plot([0,6],[7.6e-5,1.6e-6],'D',color='#1f6f8b',ms=5)
