...
*(Relativistic clause.) The law is scalar-relativistic in an essential way: repeating the construction with c → ∞ reverses the ordering at Z = 90. The observed periodic table is not a non-relativistic object.*
...
This construction has three properties that elevate it from heuristic to derivation. It is *parameter-free*: every quantity in it is produced by the equation. It is *falsifiable row by row*: each step records not just its winner but the margin of victory and the full candidate spectrum, so any single wrong entrant is visible and fatal. And it is *chained*: because step Z builds on the derived configuration of step Z−1, the 107-element score is a score of one unbroken construction. Figure 2 shows what the chain sees: the depth of every candidate channel at every Z. The bold sawtooth is the entrant — plunging when a new channel opens, resetting at every shell closure — and the grey band riding above it is the margin by which the entrant beat its closest rival, the quantity all later scrutiny (spin-orbit, correlation, numerical error) is measured against.
...
Because ground configurations are experimentally established only through Z = 108, this work enforces a strict evidentiary boundary there. The 107 elements up to it constitute the *derivation*, scored against nature. The twelve elements beyond it (Figure 3) are published as *predictions* — explicitly labeled, unfitted, and falsifiable the day their spectra can be measured: the entrant is 6d from Z = 109 through 112, 7p from 113 through 118, and 8s at 119 and 120, with stated margins between 0.058 and 0.264 hartree, every one clearing the spin-orbit worst case.

The second boundary statement is the deeper one. Repeating the entire construction with the speed of light sent to infinity — switching relativity off — changes the derived ordering at Z = 90. The periodic table hanging on the classroom wall is not a solution of the non-relativistic Schrödinger equation. Any successful answer to Löwdin's challenge *had* to contain the speed of light; a purely non-relativistic derivation, had one been found, would have derived a subtly different table than ours.
...
5. **Solve for the eigenvalue evolution with Z.** The 107-element chained construction, with the full candidate spectrum recorded at every step (Figure 2).
...
- **Figure 1 — The Filling Index, Z = 2–120.** The derived Aufbau staircase; the three exceptions ringed; the Z = 108 evidentiary boundary; Z = 109–120 as open markers, denoting predictions.
- **Figure 2 — The Spectra Index, Z = 2–120.** Every candidate channel's depth at every element; the entrant sawtooth with its margin band; the hydrogen-pinned g channels.
- **Figure 3 — The Predictions, Z = 109–120.** The twelve unfitted rows with their margins and the spin-orbit worst-case band that none of them violates.
- **Figure 4 — The Correlation Clause.** The second-order correlation correction as a fraction of the mean-field margin at the five contested elements: all positive, all widening.
- **Figures 5, 5b — The Spectra Index in three dimensions.** The full candidate sheet with the entrant path threading it, from two viewpoints.

Every figure regenerates from the archived chain output by archived scripts; the figures inherit the record's reproducibility.
...
6. Bach, V., Lieb, E. H., Loss, M. & Solovej, J. P. (1994). [the average-of-configuration well-posedness result — the well-posedness condition]
7. Hantsch, F. "Existence of minimizers in restricted Hartree–Fock theory." arXiv:1206.4932.
...
9. Dzuba, V. A. & Flambaum, V. V. [the second-order correlation potential Σ⁽²⁾ underlying the correlation clause]
...
12. Connerade, J.-P. [orbital collapse; the Reports on Progress in Physics line]
...
*DRAFT 2 ends. Author: Matthew Lach, Independent Researcher. Awaiting review.*
