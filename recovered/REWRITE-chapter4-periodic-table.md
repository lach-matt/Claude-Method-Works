...
### 4.4 What follows
Λ is the same 118 elements on different coordinates, with E = 0. It adds no physics. What it removes is the thirty-six. The rest of Part I builds it and establishes what it is; the part that follows proves why E = 0 is not an isolated virtue but the source of two others.