...
Verified on 4,000 randomly drawn triples, no failures. The full proof — that the product-of-chains embedding forces the distributive law — is carried in the Mathematical Compendium.
...
and the correspondence is exact: **all 976 down-sets of the seventeen-element poset are precisely the 976 cells** — a fifty-seven-fold compression. (The construction of the poset and the proof of the exact down-set correspondence are owed to the Mathematical Compendium.)
...
The largest antichain in Λ equals its largest rank level — the **Sperner property** — verified exactly at five cap settings by Dilworth's theorem and bipartite matching, no exceptions. At caps (3, 3, 1, 3), k ≥ 1 the maximum is 122, at rank 11. The rank sequence is **log-concave**, hence unimodal, which is why Sperner holds as a consequence rather than by coincidence. (The log-concavity computation and the Dilworth/matching argument are owed to the Mathematical Compendium.)
