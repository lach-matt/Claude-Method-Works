...
- Source: NIST ASD ver. 5.12, GSIE interface, retrieved 2026-08-09 (citation in the docstring;
  the GSIE query was the interface default, all elements Z = 1–108, ground shells + ground level —
  no query URL is stored in the file; that is the retrieval record as held).
