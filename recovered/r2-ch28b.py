...
for nm, yr in (('Hill', '1878'), ('Poincaré', '1890'), ('Freuder', '1982'), ('Mardling', '2001')):
    above = [s + i for i in range(len(U)) if s + i < 11818 and nm in U[i] and yr in U[i]]; print('  %-9s %s: above L11818 at %s' % (nm, yr, above))
c35, c36 = section_span(M, '35'), section_span(M, '36'); j35, j36 = join(M[c35[0] - 1:c35[1] - 1]), join(M[c36[0] - 1:c36[1] - 1])
