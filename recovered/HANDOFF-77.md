...
4. **Fetch the Prints & Proofs original before step 7** — `r2-ch15e`, `r2-ch15o`, `r2-ch15p`,
   ...
   11,371 lines**, written to `/home/claude/PP_The_Method_1_6.md`. **Sixteen banked instruments now
   read it.**
...
- **Keep:** BUILD90 main (unchanged since chat 62), the **Prints & Proofs** folder
  ...
  by the gate itself, now read by **sixteen** banked instruments — the certificates,
...
sixteen banked instruments read it, then gate.py census, run --core, manifest, run r2-ch16s
