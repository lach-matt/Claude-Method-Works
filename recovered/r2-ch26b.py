...
print('  L11269 (register 1779): heading %s; 1779 carries "electron count" %d, "7,260" %d (the (iii) claim is r2-ch26a §2\'s)' % (rbody(1779) is not None, ('electron count' in ' '.join(R)), 0))
