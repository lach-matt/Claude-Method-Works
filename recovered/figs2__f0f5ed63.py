...
plt.savefig('/mnt/user-data/outputs/fig4_equator_potential.png',dpi=160,bbox_inches='tight')
...
plt.savefig('/mnt/user-data/outputs/fig5_constraint_graphs.png',dpi=160,bbox_inches='tight')