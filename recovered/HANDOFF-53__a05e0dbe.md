...
- `wc -l WORKING-REGISTER.md` = **4455**; W-entries through **W-088** (NOTE: W-085 is used twice — a
  chat-50 heading reuse, not renumbered, append-only; the next W is W-089).
- rulings: `grep -c '^### RULING'` = **36** (31 appears twice); in force **1–65 + R27 Amendment**.
...
2. **Genesis 1–94 seating — M's ruling.** Seat 1–94 (no renumber); decide (a) whether to add a one-line
   bridge at the 94/165 seam noting the Λ₈ transition, (b) whether to keep the Part 0 / I–IV headers.
...
> audits A4/A5/A6, R31 last. The genesis block 1–94 is verified and parked in project knowledge; do NOT
> seat it without M's ruling on the seam-bridge and the part-headers. Nothing in this prompt asks you to
> ask M anything.
