...
if PP:
    ...
    print('   only-main lines outside D.5.9/D.5.10 (first 14):'); [print('      L%d %s' % (m_idx.get(t, 0), t[:150])) for t in only_m if m_idx.get(t, e) < heading_line(M, '0') if False]
...
probes = [('14.1', ['closed index'], 'D.5.2 L10565 a closed index'), ('14.2', ['closure operator'], 'D.5.2 L10567 ℛ the closure operator'), ('16.2', ['closure operator'], 'D.5.1 L10546 ℛ the closure operator (the same element, §14.2 at L10567)'),
          ...
          ('11.1.1', ['17'], 'Λ as 976 words in {0,1}¹⁷'), ('18.4.1', ['cap-arity'], 'the cap-arity criterion'), ('18.4.1', ['slack'], 'slack = kernel'), ('12.11.0.1', ['occupancy clock'], ''), ('12.11.0.2', ['one arrow'], ''), ('12.11.0.3', ['bridge'], ''), ('12.11.0.4', ['separation hypothesis'], ''),
